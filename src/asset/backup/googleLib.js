 ...
 */
  ...
  var K = function (a, b, c) {
    ...
    M = function (a, b, c) {
      b &&
        0 < b.length &&
        ((b = L(b)),
        c && 0 < c.length && (b += '___' + L(c)),
        28 < b.length && (b = b.substr(0, 28) + (b.length - 28)),
        (c = b),
        (b = x(ia, '_p', z())),
        (x(b, c, z())[a] = new Date().getTime()),
        K(a, '_p', c));
    },
    L = function (a) {
    ...
    function (a) {
      for (var b in a)
        if (Object.prototype.hasOwnProperty.call(a, b)) {
          var c = a[b];
          'object' == typeof c ? (D[b] = x(D, b, []).concat(c)) : x(D, b, c);
        }
      if ((b = a.u))
        (a = x(D, 'us', [])), a.push(b), (b = /^https:(.*)$/.exec(b)) && a.push('http:' + b[1]);
    },
  ]);
  var ja = /^(\/[a-zA-Z0-9_\-]+)+$/,
    S = [/\/amp\//, /\/amp$/, /^\/amp$/],
    ...
    qa = function (a, b, c, d, e) {
      var f = a.split(';'),
        ...
        k = N[l],
        p = null;
      k ? (p = k(f, b, c, d)) : R('no hint processor for: ' + l);
      p || R('failed to generate load url');
      b = p;
      c = b.match(na);
      ((d = b.match(oa)) && 1 === d.length && pa.test(b) && c && 1 === c.length) ||
        R('failed sanity: ' + a);
      try {
        if (e && 0 < e.length) {
          b = a = 0;
          for (c = {}; b < e.length; ) {
            ...
            f = typeof n;
            d =
              ('object' == f && null != n) || 'function' == f
                ? 'o' + ((Object.prototype.hasOwnProperty.call(n, h) && n[h]) || (n[h] = ++aa))
                : (typeof n).charAt(0) + n;
            Object.prototype.hasOwnProperty.call(c, d) || ((c[d] = !0), (e[a++] = n));
          }
          e.length = a;
          p = p + '?le=' + e.join(',');
        }
      ...
      return void 0 !== a
        ...
        ? (a = t.querySelector('script[nonce]'))
          ? ((a = a.nonce || a.getAttribute('nonce') || ''),
            a && a === String(a) && a.match(W) ? (D.nonce = a) : (D.nonce = null))
          : null
        : null;
    },
    wa = function (a) {
      ...
      if (e['::'] && b.length) {
        ...
        for (var f = null; (f = b.shift()); ) {
          ...
          var k = (a.length && a[a.length - 1]) || null,
            p = k;
          (k && k.hint == l) || ((p = { hint: l, features: [] }), a.push(p));
          p.features.push(f);
        }
        var n = a.length;
        if (1 < n) {
  ...
  if (Z && Z.createPolicy)
    try {
      Da = Z.createPolicy('gapi#gapi', { createHTML: m, createScript: m, createScriptURL: m });
    } catch (a) {
  ...
  H.bs0 = window.gapi._bs || new Date().getTime();
  K('bs0');
  H.bs1 = new Date().getTime();
  K('bs1');
...
gapi.load('', {
  ...
  _c: {
    jsl: {
      ...
      h: 'm;/_/scs/apps-static/_/js/k\u003doz.gapi.ko.lRvPc7YSh4I.O/am\u003dAQ/d\u003d1/rs\u003dAGLTcCPnFOs7FvH0ACzP4KJmF8NnsxVjFg/m\u003d__features__',
