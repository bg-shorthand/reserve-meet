...
//           var event = events[i];
//           var when = event.start && event.start.dateTime;
//           if (!when) {
//             when = event.start && event.start.date;
//           }
