    ...
    function (a) {
      for (var b in a)
        if (Object.prototype.hasOwnProperty.call(a, b)) {
          var c = a[b];
          'object' == typeof c ? (C[b] = r(C, b, []).concat(c)) : r(C, b, c);
        }
      if ((b = a.u))
        (a = r(C, 'us', [])), a.push(b), (b = /^https:(.*)$/.exec(b)) && a.push('http:' + b[1]);
    },
  ]);
  var ia = /^(\/[a-zA-Z0-9_\-]+)+$/,
    R = [/\/amp\//, /\/amp$/, /^\/amp$/],
    ...
    pa = function (a, b, c, d, e) {
      var f = a.split(';'),
        ...
        k = M[l],
        n = null;
      k ? (n = k(f, b, c, d)) : Q('no hint processor for: ' + l);
      n || Q('failed to generate load url');
      b = n;
      c = b.match(ma);
      ((d = b.match(na)) && 1 === d.length && oa.test(b) && c && 1 === c.length) ||
        Q('failed sanity: ' + a);
      try {
        e && 0 < e.length && (n = n + '?le=' + e.join(','));
      } catch (x) {}
      return n;
    },
    ra = function (a, b, c, d) {
    ...
    X = function () {
      ...
      return void 0 !== a
        ? a && a === String(a) && a.match(V)
          ...
          : (C.nonce = null)
        : p.querySelector
        ? (a = p.querySelector('script[nonce]'))
          ? ((a = a.nonce || a.getAttribute('nonce') || ''),
            a && a === String(a) && a.match(V) ? (C.nonce = a) : (C.nonce = null))
          : null
        : null;
    },
    ua = function (a) {
      if ('loading' != p.readyState) ta(a);
      else {
        var b = X(),
          c = '';
        null !== b && (c = ' nonce="' + b + '"');
        a = '<' + U + ' src="' + encodeURI(a) + '"' + c + '></' + U + '>';
        p.write(Y ? Y.createHTML(a) : a);
      }
    },
    ta = function (a) {
      var b = p.createElement(U);
      b.setAttribute('src', Y ? Y.createScriptURL(a) : a);
      a = X();
      null !== a && b.setAttribute('nonce', a);
      b.async = 'true';
      (a = p.getElementsByTagName(U)[0])
        ? a.parentNode.insertBefore(b, a)
        : (p.head || p.body || p.documentElement).appendChild(b);
    },
    va = function (a, b) {
      var c = b && b._c;
      if (c)
      ...
      if (e['::'] && b.length) {
        ...
        for (var f = null; (f = b.shift()); ) {
          ...
          var k = (a.length && a[a.length - 1]) || null,
            n = k;
          (k && k.hint == l) || ((n = { hint: l, features: [] }), a.push(n));
          n.features.push(f);
        }
        var x = a.length;
        if (1 < x) {
...
gapi.load('', {
  ...
  _c: {
    jsl: {
      ...
      h: 'm;/_/scs/apps-static/_/js/k\u003doz.gapi.ko.IMLXqx3Ye_o.O/am\u003dAQ/d\u003d1/rs\u003dAGLTcCOcC9u1KubZXnDb8aUyfFlt7ac7xg/m\u003d__features__',
...
async function initClient() {
  ...
  try {
    ...
    await GoogleAuth.isSignedIn.listen(updateSigninStatus);
